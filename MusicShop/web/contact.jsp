...
<html>
    <head>
        ...
        <title>LIÊN HỆ CHÚNG TÔI - PTIT ECOMMERCE</title>
			...
			<div class="col-md-4 contact-grids">
				<div class=" contact-grid animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Địa Chỉ</h4>
							Học viện Công nghệ Bưu chính Viễn thông <span>Mỗ Lao, Hà Đông, Hà Nội</span></p>
						</div>
					</div>
				</div>
				<div class=" contact-grid animated wow fadeInUp" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Gọi Chúng Tôi</h4>
							<p>090 000 0000<span>0123 456 789 </span></p>
						</div>
					</div>
				</div>
				<div class=" contact-grid animated wow fadeInRight" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Email</h4>
							<p><a href="contactto:phamducmanh.ptit@gmail.com">phamducmanh.ptit@gmail.com</a><span><a href="contactto:phamducmanh.ptit@gmail.com">lienhe@ptitecomerce.com</a></span></p>
						</div>
					</div>
				</div>
