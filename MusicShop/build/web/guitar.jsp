...
<html>
    <head>
        ...
        <title>PTIT ECOMERCE SHOP 1 - PTIT ECOMERCE</title>
...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
	...
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">PTIT ECOMERCE SHOP 1</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>PTIT ECOMERCE Shop</h3>
		<div class="clearfix"> </div>
	</div>
</div>
         <div class="login">
		<div class="container">
                    <h4 align="justify"> Chúng tôi cung cấp đầy đủ và đa dạng các sản phẩm sp1,sp2, sp3, sp4 Các thương hiệu hàng đầu thế giới được phân phối như Taylor, Fender (những thương hiệu số một tại Mỹ), hay các thương hiệu nổi tiếng Châu Á như Greg Bennett (Hàn Quốc), Takamine và Suzuki (Japan),... với chất lượng và âm thanh cao cấp.
