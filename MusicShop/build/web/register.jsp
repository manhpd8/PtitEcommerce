...
<script type="text/javascript">
	...
	<fieldset disabled>
        <div class="form-group">
          <label for="disabledTextInput">Điều khoản tại website PTIT ECOMERCE SHOP</label>
          <textarea type="text" id="disabledTextInput" class="form-control" placeholder="">* Mua hàng tại PTIT ECOMERCE không được đổi trả. &#10;* Bạn hãy chắc địa chỉ bạn gửi là đúng. &#10;* Sau 3 ngày không chuyển khoản, đơn hàng sẽ xóa.&#10;* </textarea>
          </fieldset>
