     ...
     public UserAdmin login(String email, String password) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                ad.setUseradminID(rs.getLong("user_id"));
                ad.setUseradminEmail(rs.getString("user_email"));
                ad.setUseradminPass(rs.getString("user_pass"));
                ad.setUseradminRole(rs.getBoolean("user_role"));
                con.close();
                return ad;
            }
