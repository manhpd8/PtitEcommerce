...
public boolean delete(long product_id) throws SQLException {
 ...
 public boolean insertProduct(Product c) {
   ...
   //manh
    public ArrayList<Product> getListProductByFeatured(int firstResult, int maxResult) throws SQLException{
        Connection connection = DBConnect.getConnecttion();
   ...
   //Latest
    public ArrayList<Product> getListProductByLatest(int firstResult, int maxResult) throws SQLException{
        Connection connection = DBConnect.getConnecttion();
